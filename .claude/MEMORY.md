...
- **What we decided**: Keep interview-skills qa-* component classes as WARN (works at runtime, verified); confetti guard uses the reset-on-leave pattern matching the 4 reference lessons; keep index.premium.html pending a keep/drop decision.
- **Where we left off**: All changes uncommitted on branch claude/lessons-repo-review-4d7f56 (worktree). Needs commit + merge to main before the Aug 17 meeting.

## Open Items
- [ ] Commit + PR this branch to main
...
- [ ] index.premium.html in employee-accountability: alternate build, keep or drop?
